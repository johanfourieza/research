# ============================================================================
# META HISTORY: The Roots of Social Connectedness
# ============================================================================
#
# NOTE (May 2026): This modular script is SUPERSEDED by the single consolidated
# replication file `uprooted_finalscript.R`, which inlines the six prepare_*.R
# scripts, folds in the latest referee-response analyses (network-preserving
# permutation, US-county homeland specificity, corrected Cape Colony kitchen
# sink, EU-distance robustness, slavery-null power diagnostics and
# partner-specific z-scoring), and is the version used for the published
# results. This file is retained for reference only.
#
# Analysis script — VERSION 4 (round-3 submission package for Economic Inquiry)
# Original: meta_history.R (preserved unmodified)
# Predecessor: meta_history_v2.R (post-EconGuru round-1 revision)
#
# Round-3 revisions (May 2026):
...
cat("\n============================================================\n")
cat("All phases complete (incl. Extensions 5-7). Output saved to", out_dir, "\n")
cat("============================================================\n")
